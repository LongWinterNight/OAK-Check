...
## Cross-device audit (актуальный sub-план)

После завершения базового Plan 12 пользователь нашёл несколько мест с горизонтальным scroll'ом и пустотами на узких viewport'ах. Полная ревизия адаптива по всем компонентам — в [cross-device-audit.md](./cross-device-audit.md). Это операциональный чек-лист по ролям, который нужно пройти до полной DoD.
...
- [x] **Frontend** — адаптация страниц tasks/review/auth (06) · `fdd235b`
